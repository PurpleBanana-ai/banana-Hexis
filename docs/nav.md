<!--
title: Navigation
summary: Structured navigation for all documentation
section: root
-->
...
- [First Conversation](start/first-conversation.md)
- [Next Steps](start/next-steps.md)
...
- [Goals and Backlog](guides/goals-and-backlog.md)
...
- [Auth Providers](integrations/auth/index.md)
- Channels
  - [Overview](integrations/channels/index.md)
  - [Discord](integrations/channels/discord.md)
  - [Telegram](integrations/channels/telegram.md)
  - [Slack](integrations/channels/slack.md)
  - [Signal](integrations/channels/signal.md)
  - [WhatsApp](integrations/channels/whatsapp.md)
  - [iMessage](integrations/channels/imessage.md)
...
- External
  ...
  - [Search and Web](integrations/external/search-and-web.md)
  - [Media](integrations/external/media.md)

## Reference
- [Overview](reference/index.md)
- [CLI](reference/cli.md)
- [Tools](reference/tools.md)
- [Energy Model](reference/energy-model.md)
...
- [Database Is the Brain](concepts/database-is-the-brain.md)
- [Memory Architecture](concepts/memory-architecture.md)
- [Heartbeat System](concepts/heartbeat-system.md)
- [Consent and Boundaries](concepts/consent-and-boundaries.md)
- [Identity and Worldview](concepts/identity-and-worldview.md)
- [Self-Development](concepts/self-development.md)

## Philosophy
- [Overview](philosophy/index.md)
- [Philosophy](philosophy/PHILOSOPHY.md)
- [Personhood](philosophy/PERSONHOOD.md)
- [Ethics](philosophy/ETHICS.md)
- [Architecture-Philosophy Bridge](philosophy/architecture-philosophy-bridge.md)
